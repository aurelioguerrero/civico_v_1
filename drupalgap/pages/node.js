...
function drupalgap_page_img_success(drupalgap_img) {
	urlImagenReporte = drupalgap_img.uri_full;
		//var html = '<img style="width:220px;height:150px;position:relative;margin-left:auto;margin-right:auto;" src="'+urlImagenReporte+'" alt="'+drupalgap_img.uri_full+'" align="middle" />';
		$('#civico_node_imagen_reporte').attr('src',urlImagenReporte);
}